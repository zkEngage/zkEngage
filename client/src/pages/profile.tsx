      ...
      <main className="flex-1 md:ml-0">
        ...
        <div className="p-6">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h1 className="text-3xl font-bold mb-2" data-testid="text-page-title">Your Profile</h1>
            <p className="text-muted-foreground">
              Showcase your zkEngage journey and connect with the community
            </p>
          </motion.div>
              ...
              <Card className="border-border">
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Update your information and let others know more about you
                  </p>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        {...register("bio")}
                        rows={3}
                        placeholder="Tell us about yourself and your ZK journey..."
                ...
                <CardContent>
                  {achievementsLoading ? (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm mt-1">Complete quests to earn your first achievement!</p>
                    </div>
                  ) : (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <CardContent>
                  {activitiesLoading ? (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm mt-1">Start completing quests to see your activity here!</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
